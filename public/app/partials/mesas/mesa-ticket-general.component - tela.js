...
angular.module('mesas-tickets')
    .component('mesaTicketGeneral', {
        ...
        controller: function MesasController($scope, $http, $routeParams, $location, servicio, $window) {
            ...
            // leo el número de mesa que traigo en la URL
            auxMesa = $routeParams.id;      
            $scope.codigo_mesa     = auxMesa;
            ...
            $scope.loadLineasTicket       = loadLineasTicket;
            $scope.loadMiTicketLineas     = loadMiTicketLineas;
            $scope.leoMesa                = leoMesa;

            

            // Traigo los datos de la mesa. El nombre, el tipo....
            leoMesa(auxMesa);
